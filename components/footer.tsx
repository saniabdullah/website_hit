...
export default function Footer() {
    return (
        <footer className="bg-neutral-100 text-center text-neutral-600 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left w-full">
                ...
                <div className="grid-1 grid gap-8 lg:grid-cols-2">
                    ...
                    <div className="grid-1 grid gap-8 md:grid-cols-3 lg:grid-cols-3">
                        <div className="mx-auto">
                            <h6
                            className="mb-4 flex justify-center md:justify-start font-semibold uppercase">
                                Solutions
                            </h6>
                            <p className="mb-2">
                                <a href="#!" className="text-neutral-600 dark:text-neutral-200">SAP</a>
                            </p>
                            <p className="mb-2">
                                <a href="#!" className="text-neutral-600 dark:text-neutral-200">Odoo</a>
                            </p>
                            <p className="mb-2">
                        ...
                        <div className="mx-auto">
                            ...
                            <p className="mb-2">
                            <a href="#home" className="text-neutral-600 dark:text-neutral-200"
                                >Home</a>
                            </p>
                            <p className="mb-2">
                            <a href="#partnership" className="text-neutral-600 dark:text-neutral-200"
                                >About Us</a>
                            </p>
                            <p className="mb-2">
                            <a href="#product" className="text-neutral-600 dark:text-neutral-200"
                                >Product</a>
                            </p>
                            <p className="mb-2">
                            <a href="#kontak" className="text-neutral-600 dark:text-neutral-200"
                                >Career</a>
                            </p>
                        </div>
                    </div>
                    <div className="flex-col">
                        <div className="grid-1 grid gap-8 md:grid-cols-2 lg:grid-cols-2">
                            <div className="flex">
                                ...
                                className="h-10 w-10 m-2 p-1 rounded"
                                fill="currentColor"
                                viewBox="0 0 24 24">
                                <path
