...
export default function Service ({ data }: ServiceProps) {
    return (
        ...
        >
            <div className="mt-10 w-full lg:px-20 px-4 py-5">
                <h1 className="lg:text-3xl text-xl py-2 font-bold mt-4 text-center">OUR SERVICES</h1>
                <p className="lg:text-lg text-md text-center">End to end solution for full-cycle IT needed</p>
                <div className="flex flex-wrap items-center mt-5 justify-evenly">
                    {data.map((item, index) => (
